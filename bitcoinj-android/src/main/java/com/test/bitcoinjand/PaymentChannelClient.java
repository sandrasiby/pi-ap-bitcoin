...
public class PaymentChannelClient {
    ...
    private HelloAndroidActivity con;
    PaymentChannelClientConnection client;
    
    public PaymentChannelClient(HelloAndroidActivity ctx) {
        this.context = ctx;
        this.con = ctx;
        channelSize = CENT;
        myKey = new ECKey();
    ...
    public void startWalletAppKit(){
    	
    	Log.e(TAG, "Creating App Kit");
    	
    	appKit = new WalletAppKit(TestNet3Params.get(), context.getFilesDir(), "payment_channel_example_client") {
            @Override
